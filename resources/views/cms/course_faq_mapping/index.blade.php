...
@section('body')
  <div class="row my-3">
    <div class="col-12 col-lg-12"><h1 class="font-weight-bold font-32 my-3 text-warning">Course Faq Mapping</h1></div>
  </div>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-nowrap">
            ...
            <a href="/cms/course-faq-mapping/delete/{{$mapping->id}}" class="mx-1" title="Delete"><span data-feather="trash"></span></a>
          </td>
        </tr>
        @endforeach
      </tbody>
