...
@section('body')
  <div class="row my-3">
    <div class="col-12 col-lg-12"><h1>Course Module Mapping</h1></div>
  </div>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-nowrap">
            ...
            <a href="/cms/course-module-mapping/delete" class="mx-1" title="Delete"><span data-feather="trash"></span></a>
          </td>
        </tr>
        @endforeach
      </tbody>
