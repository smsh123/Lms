    ...
    <div class="card-body">
      ...
      <div class="row form-group">
        <div class="col-lg-6">
          ...
          <input type="text" class="form-control" name="intro_video" placeholder="Intro Video Id"  />
        ...
        <div class="col-lg-6">
          ...
          <input type="text" class="form-control" name="brochure" placeholder="Brochure URL"  />
