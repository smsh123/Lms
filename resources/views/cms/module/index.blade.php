...
@section('body')
  <div class="row my-3">
    <div class="col-12 col-lg-6"><h1 class="font-weight-bold font-32 my-3 text-warning">Modules</h1></div>
  ...
  <div class="py-3">
    <nav aria-label="Page navigation" class="my-3">
      <ul class="pagination justify-content-end">
        <li class="page-item"><a class="page-link" href="{{$modules->previousPageUrl()}}">Previous</a></li>
        @for($i=1;$i<=$modules->lastPage();$i++)
          <li class="page-item"><a class="page-link" href="{{$modules->url($i)}}">{{$i}}</a></li>
        @endfor
        <li class="page-item"><a class="page-link" href="{{$modules->nextPageUrl()}}">Next</a></li>
      </ul>
    </nav>
  </div>
@stop