    ...
    <div class="card-body">
      ...
      <div class="row form-group">
        <div class="col-12 col-lg-6">
          ...
          <input id="form-image-input" type="hidden" class="form-control" value="{{ !empty($testimonial['thumbnail_image']) ? $testimonial['thumbnail_image'] : '' }}" name="thumbnail_image" />

          <div class="w-100 mw-320">
            <div class="ratio-image image_16-9">
              <img id="image-preview" src="{{ !empty($testimonial['thumbnail_image']) ? $testimonial['thumbnail_image'] : '' }}" />
            </div>
          </div>
        </div>
      </div>
