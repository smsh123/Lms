...
<html  lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    @elseif (!empty($page_type) && $page_type == 'course-details-page')
      ...
      <meta property="og:image" content="{{ !empty($CourseDescription['thumbnail_image']) ? $CourseDescription['thumbnail_image'] : '/assets/image/logo.png'}}">
      <meta property="og:image:width" content="300">
      <meta property="og:image:height" content="300">
      ...
      <meta name="twitter:image" content="{{ !empty($CourseDescription['thumbnail_image']) ? $CourseDescription['thumbnail_image'] : '/assets/image/logo.png'}}">
    ...
    @elseif (!empty($page_type) && $page_type == 'blog-details-page')
      ...
      <meta property="og:image" content="{{ !empty($BlogDescription['thumbnail_image']) ? $BlogDescription['thumbnail_image'] : '/assets/image/logo.png'}}">
      <meta property="og:image:width" content="300">
      <meta property="og:image:height" content="300">
      ...
      <meta name="twitter:image" content="{{ !empty($BlogDescription['thumbnail_image']) ? $BlogDescription['thumbnail_image'] : '/assets/image/logo.png'}}">
    @else
