...
Route::get('/categories/{slug}', 'CategoryController@categoryDetails');
...
Route::prefix('cms')->middleware(['internal'])->group(function () {
    ...
    Route::get('/brands/toggle-status/{id}', 'BrandController@changeStatus');
    ...
    Route::get('/categories/toggle-status/{id}', 'CategoryController@changeStatus');
    ...
    Route::get('/tools/toggle-status/{id}', 'ToolsController@changeStatus');
    ...
    Route::get('/courses/toggle-status/{id}', 'CourseController@changeStatus');
    ...
    Route::get('/users/toggle-status/{id}', 'UserController@changeStatus');
    ...
    Route::get('/banners/toggle-status/{id}', 'BannerController@changeStatus');
    ...
    Route::get('/blogs/toggle-status/{id}', 'BlogController@changeStatus');
    ...
    Route::get('/menus/toggle-status/{id}', 'MenuController@changeStatus');
    ...
    Route::get('/testimonials/toggle-status/{id}', 'TestimonialController@changeStatus');
    ...
    Route::get('/pages/toggle-status/{id}', 'PageController@changeStatus');
    ...
    Route::get('/modules/toggle-status/{id}', 'ModuleController@changeStatus');
    ...
    Route::get('/faq/toggle-status/{id}', 'FaqController@changeStatus');
    ...
    Route::get('/coupons/toggle-status/{id}', 'CouponController@changeStatus');
    ...
    Route::get('/sections/toggle-status/{id}', 'SectionController@changeStatus');
    ...
    Route::get('/blocks/toggle-status/{id}', 'BlockController@changeStatus');
